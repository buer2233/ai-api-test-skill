...
| 任务类型 | 适用场景 | 先读文件 |
|---|---|---|
| 新增 | 新接口、新用例、补齐新链路 | `doc/coding_style_guide.md` + 对应 `doc/mode_*.md` |
| 维护 | 既有用例修复、接口方法调整、链路回溯、参数/断言更新 | `doc/coding_style_guide.md` + `doc/maintenance_prompt_context.md` + 对应 `doc/mode_maintenance_*.md` |
